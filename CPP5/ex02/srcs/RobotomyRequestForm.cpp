...
RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm &cpy) : AForm(cpy.getName(), cpy.getGradeSignNeed(), cpy.getGradeExecuteNeed()), target(cpy.getTarget())
{
    if (LOG)
