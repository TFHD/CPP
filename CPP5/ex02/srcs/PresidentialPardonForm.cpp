...
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm &cpy) : AForm(cpy.getName(), cpy.getGradeSignNeed(), cpy.getGradeExecuteNeed()), target(cpy.getTarget())
{
    if (LOG)
