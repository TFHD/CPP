...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm &cpy) : AForm(cpy.getName(), cpy.getGradeSignNeed(), cpy.getGradeExecuteNeed()), target(cpy.getTarget())
{
    if (LOG)
